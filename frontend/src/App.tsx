...
<div className="container-fluid">
    <div className="row flex-nowrap">
        ...
        <div className="py-3 mx-auto btn-primary  d-flex align-items-center flex-column" style={{width: '50%'}}>
          <p className="lead">Hi. I'm here.fhsdkfhsjkfhkjdhfsjhfsjkdhfdjkshfdskhkdfdfdhksjhfkds
